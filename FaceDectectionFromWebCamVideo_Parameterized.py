...
def RunFaceDetectWithParam(modelpath = 'C:/Users/HP/Documents/Python/faces/AllEmp_ResizeEqBl.yml',
                  label_names = ['', 'akash', 'aravind', 'Harini', 'karthick_aravindan', 'Karthic_Chandran', 'keerthana', 'lalitha', 'Mani', 'Steve'],
                  trans = ['resize']):
    cascPath = "c:/Users/HP/Miniconda3/Library/etc/haarcascades/haarcascade_frontalface_default.xml"
